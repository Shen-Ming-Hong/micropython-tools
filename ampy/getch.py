...
class _Getch:
    ...
    def __init__(self):
        try:
            ...
            # Skip Carbon on modern macOS as it's deprecated and causes issues with PyInstaller
            # try:
...
class _GetchMacCarbon:
    ...
    NOTE: Disabled for modern macOS compatibility and PyInstaller support
    """
    def __init__(self):
        # import Carbon
        # Carbon.Evt #see if it has this (in Unix, it doesn't)
        raise ImportError("Carbon module is deprecated and not available")
